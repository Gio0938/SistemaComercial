...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class="fas fa-plus me-2"></i>Crear Nueva Promoción</h1>
    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="tipo_promocion" name="tipo_promocion" required>
                                ...
                                <option value="Porcentaje" {{ old('tipo_promocion') == 'Porcentaje' ? 'selected' : '' }}>Porcentaje de descuento</option>
                                <option value="Fijo" {{ old('tipo_promocion') == 'Fijo' ? 'selected' : '' }}>Monto fijo de descuento</option>
                                <option value="2x1" {{ old('tipo_promocion') == '2x1' ? 'selected' : '' }}>2x1</option>
                                <option value="3x2" {{ old('tipo_promocion') == '3x2' ? 'selected' : '' }}>3x2</option>
                                <option value="Envio Gratis" {{ old('tipo_promocion') == 'Envio Gratis' ? 'selected' : '' }}>Envío Gratis</option>
                            </select>
                        </div>
                        ...
                        <div id="campo-descuento" class="mb-3" style="display: none;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="descuento" name="descuento" value="{{ old('descuento') }}">
                            </div>
                        </div>
                        ...
                        <div id="campo-precio-promocional" class="mb-3" style="display: none;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="precio_promocional" name="precio_promocional" value="{{ old('precio_promocional') }}">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="codigo_promocion" class="form-label">Código de Promoción</label>
                            <input type="text" class="form-control" id="codigo_promocion" name="codigo_promocion" value="{{ old('codigo_promocion') }}" placeholder="Opcional">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="fecha_fin" name="fecha_fin" value="{{ old('fecha_fin', date('Y-m-d', strtotime('+30 days'))) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="limite_usos" name="limite_usos" value="{{ old('limite_usos') }}" placeholder="Dejar vacío para ilimitado">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="condiciones" name="condiciones" rows="3" placeholder="Términos y condiciones adicionales">{{ old('condiciones') }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="aplica_todos_servicios" name="aplica_todos_servicios" {{ old('aplica_todos_servicios') ? 'checked' : '' }}>
                            ...
                            <div class="mb-2" id="select-servicio">
                                ...
                                <select class="form-control" id="servicio_id" name="servicio_id">
                                    ...
                                    @foreach($servicios as $servicio)
                                        <option value="{{ $servicio->idserv }}" {{ old('servicio_id') == $servicio->idserv ? 'selected' : '' }}>
                            ...
                            <div class="mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="aplica_todos_productos" name="aplica_todos_productos" {{ old('aplica_todos_productos') ? 'checked' : '' }}>
                            ...
                            <div class="mb-2" id="select-producto">
                                ...
                                <select class="form-control" id="producto_id" name="producto_id">
                                    ...
                                    @foreach($productos as $producto)
                                        <option value="{{ $producto->idprod }}" {{ old('producto_id') == $producto->idprod ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="activa" name="activa" {{ old('activa', true) ? 'checked' : '' }}>
