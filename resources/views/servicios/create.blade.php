...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class="fas fa-plus me-2"></i>Crear Nuevo Servicio</h1>
    </div>
            ...
            <form action="{{ route('servicios.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="checkbox-group">
                                <div class="form-check checkbox-item">
                                    <input class="form-check-input" type="radio" name="tipo_servicio" id="interno" value="Interno" {{ old('tipo_servicio') == 'Interno' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="interno">Interno</label>
                                </div>
                                <div class="form-check checkbox-item">
                                    <input class="form-check-input" type="radio" name="tipo_servicio" id="externo" value="Externo" {{ old('tipo_servicio') == 'Externo' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="externo">Externo</label>
                                </div>
                                <div class="form-check checkbox-item">
                                    <input class="form-check-input" type="radio" name="tipo_servicio" id="domicilio" value="Domicilio" {{ old('tipo_servicio') == 'Domicilio' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="domicilio">Domicilio</label>
                                </div>
                                <div class="form-check checkbox-item">
                                    <input class="form-check-input" type="radio" name="tipo_servicio" id="online" value="Online" {{ old('tipo_servicio') == 'Online' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.5" class="form-control" id="duracion" name="duracion" value="{{ old('duracion') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="personal_requerido" class="form-label">Personal Requerido</label>
                                    <input type="number" class="form-control" id="personal_requerido" name="personal_requerido" value="{{ old('personal_requerido') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="materiales_incluidos" name="materiales_incluidos" {{ old('materiales_incluidos') ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="garantia" name="garantia" {{ old('garantia') ? 'checked' : '' }}>
